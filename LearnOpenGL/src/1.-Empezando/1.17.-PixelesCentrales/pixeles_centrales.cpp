...
int main() {
	...
	Shader ourShader("./src/1.-Empezando/1.17.-PixelesCentrales/shader.vert", "./src/1.-Empezando/1.17.-PixelesCentrales/shader.frag");
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_NEAREST); // Establecen parámetros de textura
