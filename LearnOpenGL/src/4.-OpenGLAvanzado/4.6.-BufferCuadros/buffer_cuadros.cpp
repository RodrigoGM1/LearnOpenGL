...
int main() {
	...
	Shader shader("./src/4.-OpenGLAvanzado/4.3.-Mezcla/mezcla.vert", "./src/4.-OpenGLAvanzado/4.3.-Mezcla/mezcla.frag");
	...
	unsigned int transparentTexture = cargarImagen("./texturas/grass.png");
