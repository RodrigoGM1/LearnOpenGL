...
int main() {
	...
	Shader shader("./src/4.-OpenGLAvanzado/4.6.-BufferCuadros/framebuffer.vert", "./src/4.-OpenGLAvanzado/4.6.-BufferCuadros/framebuffer.frag");
	Shader screenShader("./src/4.-OpenGLAvanzado/4.6.-BufferCuadros/framebuffer_screen.vert", "./src/4.-OpenGLAvanzado/4.6.-BufferCuadros/framebuffer_screen.frag");
