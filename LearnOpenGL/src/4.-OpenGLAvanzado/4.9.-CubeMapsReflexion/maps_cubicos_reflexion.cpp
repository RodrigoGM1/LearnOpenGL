...
int main() {
	...
	Shader shader("./src/4.-OpenGLAvanzado/4.9.-CubeMapsReflexion/cubo.vert", "./src/4.-OpenGLAvanzado/4.9.-CubeMapsReflexion/cubo.frag");
	Shader skyboxShader("./src/4.-OpenGLAvanzado/4.9.-CubeMapsReflexion/skybox.vert", "./src/4.-OpenGLAvanzado/4.9.-CubeMapsReflexion/skybox.frag");
