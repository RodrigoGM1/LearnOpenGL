...
int main() {
	...
	Shader shader("./src/4.-OpenGLAvanzado/4.2.-StencilTesting/profundidad.vert", "./src/4.-OpenGLAvanzado/4.2.-StencilTesting/profundidad.frag");
	Shader shaderSingleColor("./src/4.-OpenGLAvanzado/4.2.-StencilTesting/profundidad.vert", "./src/4.-OpenGLAvanzado/4.2.-StencilTesting/shaderSingleColor.frag");
	...
	unsigned int cubeTexture = cargarImagen("./texturas/marble.jpg");
