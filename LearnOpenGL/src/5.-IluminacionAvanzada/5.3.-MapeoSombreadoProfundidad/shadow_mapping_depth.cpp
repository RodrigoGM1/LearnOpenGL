...
int main() {
	...
	Shader simpleDepthShader("./src/5.-IluminacionAvanzada/5.3.-MapeoSombreadoProfundidad/mapa_profundidad.vert", "./src/5.-IluminacionAvanzada/5.3.-MapeoSombreadoProfundidad/mapa_profundidad.frag");
	Shader debugDepthQuad("./src/5.-IluminacionAvanzada/5.3.-MapeoSombreadoProfundidad/debug_quad.vert", "./src/5.-IluminacionAvanzada/5.3.-MapeoSombreadoProfundidad/debug_quad.frag");
