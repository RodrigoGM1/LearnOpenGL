...
int main() {
	...
	Shader shader("./src/5.-IluminacionAvanzada/5.4.-ReprecentacionSombras/sombreador_mapas.vert", "./src/5.-IluminacionAvanzada/5.4.-ReprecentacionSombras/sombreador_mapas.frag");
	Shader simpleDepthShader("./src/5.-IluminacionAvanzada/5.4.-ReprecentacionSombras/mapa_profundidad.vert", "./src/5.-IluminacionAvanzada/5.4.-ReprecentacionSombras/mapa_profundidad.frag");
	Shader debugDepthQuad("./src/5.-IluminacionAvanzada/5.4.-ReprecentacionSombras/debug_quad.vert", "./src/5.-IluminacionAvanzada/5.4.-ReprecentacionSombras/debug_quad.frag");
