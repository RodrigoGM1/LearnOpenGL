...
int main() {
	...
	Shader shader("./src/5.-IluminacionAvanzada/5.9.-MapeoParalejePronunciado/mapa_paraje.vert", "./src/5.-IluminacionAvanzada/5.9.-MapeoParalejePronunciado/mapa_paraje.frag");

	unsigned int diffuseMap = cargarImagen("./texturas/wood.png");
	unsigned int normalMap = cargarImagen("./texturas/toy_box_normal.png");
	unsigned int heightMap = cargarImagen("./texturas/toy_box_disp.png");
