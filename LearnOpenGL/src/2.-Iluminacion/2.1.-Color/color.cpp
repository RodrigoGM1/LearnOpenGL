...
int main() {
	...
	Shader lightingShader("./src/2.-Iluminacion/2.1.-Color/cubo.vert", "./src/2.-Iluminacion/2.1.-Color/cubo.frag");
	Shader lightCubeShader("./src/2.-Iluminacion/2.1.-Color/luz.vert", "./src/2.-Iluminacion/2.1.-Color/luz.frag");
