...
int main() {
	...
	Shader lightingShader("./src/2.-Iluminacion/2.18.-LucesMultiples/cubo.vert", "./src/2.-Iluminacion/2.18.-LucesMultiples/cubo.frag");
	Shader lightCubeShader("./src/2.-Iluminacion/2.18.-LucesMultiples/luz.vert", "./src/2.-Iluminacion/2.18.-LucesMultiples/luz.frag");
