...
int main() {
	...
	Shader lightingShader("./src/2.-Iluminacion/2.2.-IluminacionAmbiental/cubo.vert", "./src/2.-Iluminacion/2.2.-IluminacionAmbiental/cubo.frag");
	Shader lightCubeShader("./src/2.-Iluminacion/2.2.-IluminacionAmbiental/luz.vert", "./src/2.-Iluminacion/2.2.-IluminacionAmbiental/luz.frag");
