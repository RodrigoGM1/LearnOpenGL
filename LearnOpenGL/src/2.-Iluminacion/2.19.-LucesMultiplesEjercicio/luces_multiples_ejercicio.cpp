...
int main() {
	...
	Shader lightingShader("./src/2.-Iluminacion/2.19.-LucesMultiplesEjercicio/cubo.vert", "./src/2.-Iluminacion/2.19.-LucesMultiplesEjercicio/cubo.frag");
	Shader lightCubeShader("./src/2.-Iluminacion/2.19.-LucesMultiplesEjercicio/luz.vert", "./src/2.-Iluminacion/2.19.-LucesMultiplesEjercicio/luz.frag");
	...
	// Configuracion del primer cubo luz
	...
	while (!glfwWindowShouldClose(window)) {
		...
		lightingShader.setVec3("pointLights[0].ambient", pointLightPositions[0].x * 0.1, pointLightPositions[0].y * 0.1, pointLightPositions[0].z * 0.1);
		...
		lightingShader.setVec3("spotLight.position", camara.Position);
		lightingShader.setVec3("spotLight.direction", camara.Front);
